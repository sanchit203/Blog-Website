...
app.get('/', function(req, res)
{
  Post.find({}, function(err, Posts)
  {
    if(!err)
    {
    res.render('home', {homeStart : homeStartingContent , allPosts : Posts});
    }
...
app.get("/posts/:id", function(req,res){
  const requestedElement = string=req.params.id
  Post.findById({_id : requestedElement}, function(err, foundpost){
    if(!err)
    {
...
app.post('/', function(req,res){
  const post = new Post({
    title : string =lodash.capitalize([string = req.body.blogTitle]),
